...
|---|------------------|---------------|---------------------|------------|-----------|
| 1 | Page Background  | Surface       | --bg-main            | bg-main.webp (repeat) | #111827 |
...
|23 | Button Ghost     | Border        | --btn-gho-border     | #D1D5DB   | #4B5563   |
 ...
 1. Типографіка                                                                                                                                                                                                                    
  ...
  5.2 Кольори фільтрів та контейнерів (Index page)

  ┌────────────────────────────┬─────────────┐
  │           Елемент          │    Колір    │
  ├────────────────────────────┼─────────────┤
  │ Hero / Search container    │ #D2D2D2     │
  ├────────────────────────────┼─────────────┤
  │ Filter panel (aside)       │ #D2D2D2     │
  ├────────────────────────────┼─────────────┤
  │ Search bar background      │ #D2D2D2     │
  └────────────────────────────┴─────────────┘
