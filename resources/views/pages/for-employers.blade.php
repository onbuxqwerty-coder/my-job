...
<section class="bg-slate-50 py-20 lg:py-28">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            ...
            <p class="text-lg text-slate-500 max-w-2xl mx-auto">Повний цикл найму — від оголошення до виходу нового співробітника</p>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {{-- Feature 1 --}}
            <div class="bg-white rounded-2xl p-7 shadow-sm border border-slate-100 hover:shadow-md transition-shadow duration-200">
                <div class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-blue-50 text-blue-600 mb-5">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 19l9 2-9-18-9 18 9-2zm0 0v-8"/></svg>
                </div>
                <h3 class="text-lg font-bold text-slate-900 mb-2">Telegram-розсилка</h3>
                <p class="text-slate-500 text-sm leading-relaxed">Кожна нова вакансія автоматично надходить підписникам Telegram-каналу. Миттєве охоплення аудиторії.</p>
            </div>
            {{-- Feature 2 --}}
            <div class="bg-white rounded-2xl p-7 shadow-sm border border-slate-100 hover:shadow-md transition-shadow duration-200">
                <div class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-green-50 text-green-600 mb-5">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                </div>
                <h3 class="text-lg font-bold text-slate-900 mb-2">Аналітика відгуків</h3>
                <p class="text-slate-500 text-sm leading-relaxed">Перегляди, відгуки, конверсія по кожній вакансії. Розумійте, що працює, а що — ні.</p>
            </div>
            {{-- Feature 3 --}}
            <div class="bg-white rounded-2xl p-7 shadow-sm border border-slate-100 hover:shadow-md transition-shadow duration-200">
                <div class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-purple-50 text-purple-600 mb-5">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z"/></svg>
                </div>
                <h3 class="text-lg font-bold text-slate-900 mb-2">Шаблони повідомлень</h3>
                <p class="text-slate-500 text-sm leading-relaxed">Готові шаблони для комунікації з кандидатами — запрошення на інтерв'ю, відмова, пропозиція. Економте час HR.</p>
            </div>
            {{-- Feature 4 --}}
            <div class="bg-white rounded-2xl p-7 shadow-sm border border-slate-100 hover:shadow-md transition-shadow duration-200">
                <div class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-orange-50 text-orange-600 mb-5">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/></svg>
                </div>
                <h3 class="text-lg font-bold text-slate-900 mb-2">Управління командою</h3>
                <p class="text-slate-500 text-sm leading-relaxed">Додавайте HR-менеджерів до свого акаунту. Розподіляйте вакансії та кандидатів між членами команди.</p>
            </div>
            {{-- Feature 5 --}}
            <div class="bg-white rounded-2xl p-7 shadow-sm border border-slate-100 hover:shadow-md transition-shadow duration-200">
                <div class="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-red-50 text-red-600 mb-5">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                </div>
                <h3 class="text-lg font-bold text-slate-900 mb-2">Планування інтерв'ю</h3>
                <p class="text-slate-500 text-sm leading-relaxed">Зручний календар співбесід з нагадуваннями. Кандидати отримують автоматичні сповіщення про час і місце.</p>
            </div>
            {{-- Feature 6 --}}
            <div class="bg-white rounded-2xl p-7 shadow-sm border border-slate-100 hover:shadow-md transition-shadow duration-200">
                ...
                <h3 class="text-lg font-bold text-slate-900 mb-2">Підняття та топ-позиції</h3>
                <p class="text-slate-500 text-sm leading-relaxed">Виділяйте вакансії у пошуку — «Гаряча» або «Топ». Більше переглядів, більше кандидатів у найкоротший термін.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            @foreach($plans as $plan)
                ...
                @endphp
                <div class="relative rounded-3xl border-2 p-8 flex flex-col {{ $isPopular ? 'border-blue-500 bg-blue-600 text-white shadow-2xl shadow-blue-500/30 -mt-4 -mb-4' : 'border-slate-200 bg-white text-slate-900 shadow-sm' }}">
                    @if($isPopular)
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex items-end gap-1 mt-4">
                            ...
                            <span class="{{ $isPopular ? 'text-blue-200' : 'text-slate-400' }} text-sm mb-1.5">грн/міс</span>
                        </div>
                    </div>
