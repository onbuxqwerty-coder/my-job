    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl border employer-card-border dark:border-gray-700 shadow-sm overflow-hidden">
            ...
            <form wire:submit="save" class="p-6 space-y-5">
                ...
                {{-- Telegram ID --}}
                <div class="rounded-xl bg-gray-50 dark:bg-gray-700/60 border border-gray-200 dark:border-gray-600 p-4">
                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1.5">Telegram ID</label>
                ...
                <div x-data="{
                ...
                }" class="rounded-xl bg-gray-50 dark:bg-gray-700/60 border border-gray-200 dark:border-gray-600 p-4 space-y-4">

                    {{-- Header row --}}
                    <div class="flex items-center justify-between">
                        <span class="text-sm font-medium text-gray-700 dark:text-gray-200">
                            Зміна пароля
                            <span class="text-gray-400 dark:text-gray-500 font-normal ml-1">(залиште порожнім, щоб не змінювати)</span>
                        </span>
                        <div class="flex items-center gap-2">
                            {{-- Copy --}}
                            <button type="button" @click="copy()"
                                    title="Скопіювати пароль"
                                    class="flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium rounded-lg border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:border-blue-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
                            ...
                            <button type="button" @click="generate()"
                                    ...
                                    class="flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium rounded-lg border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-600 dark:text-gray-300 hover:border-purple-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors">
                    ...
                    {{-- New password --}}
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1.5">Новий пароль</label>
                        <div class="relative">
                            <input id="pwd-new" wire:model="password"
                                   :type="showNew ? 'text' : 'password'"
                                   placeholder="Мінімум 8 символів"
                                   class="w-full px-4 py-2.5 pr-10 text-sm border border-gray-200 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400">
                    ...
                    {{-- Confirm password --}}
                    <div>
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-1.5">Підтвердження пароля</label>
                        <div class="relative">
